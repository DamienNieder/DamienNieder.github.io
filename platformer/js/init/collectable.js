(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.db, 400, 460, 4);
        collectable.create(type.kennedi, 200, 100, 7, .5);
        collectable.create(type.max, 700, 600, 4, 1);
        // example: 
        collectable.create(type.steve, 609, 170, 6, 0.7);
